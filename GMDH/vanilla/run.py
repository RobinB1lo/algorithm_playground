...
def main():
    """Create a synthetic dataset and run GMDH."""
    
    print("=" * 80)
    print("GMDH: Synthetic Dataset Example")
    print("=" * 80)
    ...
    gmdh.print_equation(feature_names=['x0', 'x1', 'x2'])
    ...
    y_train_pred = gmdh.predict(X_train)
    y_test_pred = gmdh.predict(X_test)
